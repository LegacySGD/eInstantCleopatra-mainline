...
public class CleopatraCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CleopatraCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CleopatraIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CleopatraIW/InitOutcome.xml").getDocumentElement();
